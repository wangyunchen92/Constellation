...
@interface YMCameraController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
- (void)customUI{
    ...
    _PhotoButton.frame = CGRectMake(SCREEN_WIDTH * 1/2.0 - 30, SCREEN_HEGIHT - 100, 60, 60);
    ...
    leftButton.frame = CGRectMake(SCREEN_WIDTH*1/4.0-30, SCREEN_HEGIHT-100, 60, 60);
...
- (void)customCamera{
    ...
    self.previewLayer.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEGIHT);
