...
@interface YMVideoRecordController ()<AVCaptureMetadataOutputObjectsDelegate,UIAlertViewDelegate>
...
@implementation YMVideoRecordController
...
- (void)customUI{
    ...
    _PhotoButton.frame = CGRectMake(SCREEN_WIDTH * 0.5 - 30, SCREEN_HEGIHT - 100, 60, 60);
    ...
    _focusView.layer.borderColor = DefaultNavBarColor.CGColor;
    _focusView.backgroundColor = [UIColor clearColor];
    [self.view addSubview:_focusView];
    _focusView.hidden = YES;
    
    UIButton *leftButton = [UIButton buttonWithType:UIButtonTypeCustom];
    leftButton.frame = CGRectMake(SCREEN_WIDTH * 0.25 - 30, SCREEN_HEGIHT-100, 60, 60);
    ...
    rightButton.frame = CGRectMake(SCREEN_WIDTH - 42 - 15,  20, 56, 42);
    // [rightButton setTitle:@"切换" forState:UIControlStateNormal];
    // rightButton.titleLabel.textAlignment = NSTextAlignmentCenter;
    [rightButton setImage:[UIImage imageNamed:@"camera_icon"] forState:UIControlStateNormal];
    [rightButton addTarget:self action:@selector(changeCamera) forControlEvents:UIControlEventTouchUpInside];
    [self.view addSubview:rightButton];
    
    //    _flashButton = [UIButton buttonWithType:UIButtonTypeCustom];
    //    _flashButton.frame = CGRectMake(SCREEN_WIDTH-80, SCREEN_HEGIHT-100, 80, 60);
...
- (void)customCamera{
    ...
    self.previewLayer.frame = CGRectMake(0, SCREEN_HEGIHT - SCREEN_WIDTH * 1.25, SCREEN_WIDTH , SCREEN_WIDTH * 1.25);
